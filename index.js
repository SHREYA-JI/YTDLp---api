const { ytmp3, ttdl, igdl, ytmp4, transcript, pindl, mfdl, fbPhoto, ttdl2, fbVideo, ytmp3v2, ytmp4v2 } = require("./api/downloader.js")
const { tiktoks, pinterest, search, GoogleImage, lyrics, netflixTrending, ppcp  } = require("./api/search.js")
